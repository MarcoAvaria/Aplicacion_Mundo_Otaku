    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          _InkRow(
            tokens: tokens,
            // El nombre y el interruptor tienen que llegar como **un solo
            // nodo** al lector de pantalla. Sin esto, el interruptor viaja
            // sin nombre y la palabra "Modo oscuro", al no tener acción
            // propia, se va al nodo grande de la ruta del menú: se anuncia
            // el estado, pero nunca de qué.
