...
/// Botón de acceso con la sombra dura impresa de la dirección.
///
/// Declara `button: true` explícitamente: el recorrido lo busca por rol con el
/// nombre "Iniciar sesión", y un `InkWell` suelto no basta para eso.
