...
class RegisterScreenRespaldo extends StatelessWidget {
  static const String name = 'register_screen_respaldo';

  const RegisterScreenRespaldo({super.key});
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          MyFieldText( varTextCtrl: emailController, label: "Correo electrónico", darkText: false),
          const SizedBox(height: 10),
